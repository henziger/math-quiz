const QUESTIONS = [
  ...
  {
    question:
      "\\text{Bestäm den lösning till differentialekvationen }y'' + 2y' - 8y = (5x + 6)e^{x}\\text{, som uppfyller }y(0) = 0 y'(0) = 1.",
    key: 'Q2',
    category: 'diffeq',
    answers: [
  ...
  {
    question:
      '\\text{Låt }A = \\begin{pmatrix} 1 & 2 & 1 \\\\ 3 & 5 & 7 \\\\ 9 & 7 & 3 \\end{pmatrix}\\text{, ange }A^{T}.',
    key: 'Q3',
    category: 'linalg',
    answers: [
      {
        text: 'A^{T} = \\begin{pmatrix} 1 & 2 & 1 \\\\ 7 & 5 & 3 \\\\ 3 & 7 & 9 \\end{pmatrix}',
        key: '3a',
      },
      {
        text: 'A^{T} = \\begin{pmatrix} 9 & 7 & 3 \\\\ 2 & 5 & 7 \\\\ 1 & 3 & 9 \\end{pmatrix}',
        key: '3b',
      },
      {
        text: 'A^{T} = \\begin{pmatrix} 1 & 3 & 9 \\\\ 2 & 5 & 7 \\\\ 1 & 7 & 3 \\end{pmatrix}',
        key: '3c',
      },
      {
        text: 'A^{T} = \\begin{pmatrix} 9 & 3 & 1 \\\\ 7 & 5 & 2 \\\\ 3 & 7 & 1 \\end{pmatrix}',
        key: '3d',
      },
    ],
    correct: 2,
  ...
  {
    question:
      '\\text{Ange alla positiva heltal }(x, y)\\text{ sådana att }198x + 77y = 3476.',
    category: 'discrete',
    key: 'Q4',
    answers: [
  ...
  {
    question:
      '\\text{Låt }A = \\begin{pmatrix} 2 & -2 & 0 \\\\ -1 & 5 & 1 \\\\ 3 & 4 & 5 \\end{pmatrix}\\text{, ange }det(A).',
    key: 'Q8',
    category: 'linalg',
    answers: [
