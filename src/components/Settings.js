        ...
        <div className="wrapper">
            ...
            <div className="settings-container">
                <div className="options">
                    <h2>Math Topics</h2>
                    <label><input type="checkbox" onChange={updateTopics} value="discrete" checked={checkedBox["discrete"]}/> Discrete Mathematics</label>
                    <label><input type="checkbox" onChange={updateTopics} value="linalg" checked={checkedBox["linalg"]}/> Linear Algebra</label>
                    <label><input type="checkbox" onChange={updateTopics} value="calculus" checked={checkedBox["calculus"]}/> Calculus</label><br/>
                    <label><input type="checkbox" onChange={updateTopics} value="multicalc" checked={checkedBox["multicalc"]}/> Multivariable Calculus</label>
                    <label><input type="checkbox" onChange={updateTopics} value="statistics" checked={checkedBox["statistics"]}/> Statistics and Probability</label>
...
Settings.propTypes = {
    ...
    checkedBox: PropTypes.object.isRequired,
